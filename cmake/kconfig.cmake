...
if(EXISTS ${BOARD_DEFCONFIG})
    message(STATUS "platform=${PX4_PLATFORM}, model=${PX4_BOARD_MODEL}, label=${LABEL}")
    message(STATUS "defconfig path:${DEFCONFIG_PATH}, board_defconfig: ${BOARD_DEFCONFIG}, board_config: ${BOARD_CONFIG}")
    ...
    if(${LABEL} MATCHES "recovery" OR ${LABEL} MATCHES "bootloader" OR ${LABEL} MATCHES "canbootloader")
        message(STATUS "matched label ${LABEL}, use defconfig, env = ${COMMON_KCONFIG_ENV_SETTINGS}, bin dir = ${PX4_BINARY_DIR}")
		...
		execute_process(
			COMMAND ${CMAKE_COMMAND} -E env ${COMMON_KCONFIG_ENV_SETTINGS}
			${PYTHON_EXECUTABLE} ${PX4_SOURCE_DIR}/Tools/kconfig/merge_config.py ${PX4_SOURCE_DIR}/Kconfig
				${BOARD_CONFIG} ${PX4_BOARD_DIR}/default.px4board ${BOARD_DEFCONFIG}
			WORKING_DIRECTORY ${PX4_SOURCE_DIR}
			OUTPUT_VARIABLE DUMMY_RESULTS
		)
	endif()
