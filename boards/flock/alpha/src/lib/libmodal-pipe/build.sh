...
# remove this if you won't want to build with mavlink, or call cmake yourself
# without this option. The android build does not use mavlink support!
EXTRA_OPTS="-DCMAKE_C_FLAGS=-DENABLE_MAVLINK_SUPPORT"
